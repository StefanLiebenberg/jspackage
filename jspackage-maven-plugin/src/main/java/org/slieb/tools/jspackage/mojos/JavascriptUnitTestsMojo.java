...
import static slieb.kute.Kute.asReadableProvider;
...
public class JavascriptUnitTestsMojo extends AbstractPackageMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        ResourceProvider<Resource.Readable> sourceResources =
                filterResources(Kute.asReadableProvider(getPackageProvider(false)),
        ...
        ResourceProvider<Resource.Readable> testResources = asReadableProvider(getTestResources());
        ...
        ResourceProvider<? extends Resource.Readable> testProvider = filterResources(testResources,
